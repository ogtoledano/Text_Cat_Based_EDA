...
if __name__ == "__main__":
    ...
    for i in range(dic_param['num_executions']):  # Total measurement
        ...
        param_distribution = {'centroid': dic_param['centroid_distribution'], 'sigma': dic_param['sigma_distribution'],
                              'mode': ["EDA_EMNA"]}

        param_model = {"generations": dic_param['generations'], 'mode': "EDA_EMNA",
        ...
        log_exp_run.experiments(dic_param['cnn_optimizer'] + " + EDA_EMNA: Process ends successfully!")
